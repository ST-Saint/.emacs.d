...
(use-package symbol-overlay
  ...
  (set-face-attribute 'symbol-overlay-default-face nil :background nil :distant-foreground nil :underline '(:color foreground-color :style double-line :position t) :inherit nil))
#+end_src
...
(defun focus-new-window (new-window &rest _)
  (select-window new-window))

(advice-add 'split-window-below :after #'focus-new-window)
(advice-add 'split-window-right :after #'focus-new-window)
...
(use-package calfw
  ...
  (unbind-key "C-v" cfw:calendar-mode-map)
  (unbind-key "M-v" cfw:calendar-mode-map))

(use-package calfw-blocks
  :ensure nil
  :vc (:url "https://github.com/ml729/calfw-blocks" :rev "0fe8290")
  :config
