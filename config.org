...
** jump
#+begin_src emacs-lisp
(add-hook 'xref-after-jump-hook (lambda () (progn (set-mark-command nil) (set-mark-command nil))))
#+end_src
...
(use-package consult
  ...
  (add-hook 'consult-after-jump-hookd (lambda () (progn (set-mark-command nil) (set-mark-command nil))))
...
(use-package org-pdftools
  :after quelpa quelpa-use-package pdf-tools
...
(use-package org-noter-pdftools
  :after quelpa quelpa-use-package org-pdftools org-noter
  :bind
