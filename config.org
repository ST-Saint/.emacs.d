...
** jump
#+begin_src emacs-lisp
(add-hook 'xref-after-jump-hook (lambda () (set-mark-command nil) (set-mark-command nil)))
#+end_src
...
(use-package consult
  ...
  (add-hook 'consult-after-jump-hook (lambda () (set-mark-command nil) (set-mark-command nil)))
