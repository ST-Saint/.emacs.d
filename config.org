...
(use-package org-noter-pdftools
  ...
  (:map pdf-view-mode-map
        ("C-x m i i" . #'org-noter-pdftools-insert-precise-note-underline)
        ("C-x m i u" . #'org-noter-pdftools-insert-precise-note-underline)
        ("C-x m i s" . #'org-noter-pdftools-insert-precise-note-squiggly)
